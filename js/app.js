...
let guessQuestion = prompt("How many middle names does K'hari have?");

if (guessQuestion === 4 || guessQuestion === "four").toLowerCase(); {
alert("Somebody was paying attention! K'hari does indeed have" + guessQuestion + "middle names")
} else {
